...
<caption id="add" style="color:white;">사원 추가</caption>
		<tr>
			<td>사진 등록 :</td>
		...
		<tr>
			<td>비고 : </td>
			<td><input type="text" name="con" style="width: 100%;"/></td>
		</tr>
		<tr>
			<td><input type="submit" value="저장하기"/><br/><input type="button" onclick="location.href='list'" value="돌아가기"/></td>
